  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center">
              ...
              >
                <h1 className="text-2xl font-bold bg-gradient-to-r from-green-600 via-green-500 to-green-400 bg-clip-text text-transparent tracking-tight">
                  Pangan Jawara
                </h1>
              </div>
            </div>
            ...
            <button
              ...
              className="lg:hidden p-3 rounded-2xl bg-white/20 backdrop-blur-2xl border border-white/30 hover:bg-white/30 hover:border-white/40 transition-all duration-500 focus:outline-none focus:ring-2 focus:ring-white/40 hover:scale-105 shadow-xl shadow-white/10 hover:shadow-2xl hover:shadow-white/20"
              style={{
                background: `
                  linear-gradient(135deg, 
                    rgba(255,255,255,0.25) 0%, 
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-white/20 backdrop-blur-3xl"
               style={{
                 background: `
            ...
            <div className="container mx-auto px-6 py-6">
              <div className="backdrop-blur-2xl rounded-3xl p-4 border border-white/30 shadow-2xl shadow-white/10"
                   style={{
                     background: `
                       linear-gradient(135deg, 
                         rgba(255,255,255,0.25) 0%, 
            ...
            <div className="relative">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-gray-200">
                  <span className="text-green-400">📧</span> support@panganjawara.id
                </p>
                <p className="text-gray-200">
                  <span className="text-green-400">📞</span> 0800-JAWARA
                </p>
                <p className="text-gray-200">
                  <span className="text-green-400">💬</span> +62 812-JAWARA-90
                </p>
              </div>
